...
//!
//! [`ExpireSnapshots`] expires snapshots and then deletes the files they leave unreferenced,
//! building on the core [`iceberg::transaction::unreferenced_files`] detection.
